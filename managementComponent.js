                            ...
                            <div class="space-y-3">
                                ...
                                <div class="space-y-3">
                                    <div class="grid gap-3 md:grid-cols-3">
                                        ...
                                        <div id="tableReceiptSettings" class="bg-gray-50 rounded-lg p-3 border border-gray-200 hidden opacity-60">
                                            <p class="text-xs font-semibold text-gray-600 uppercase tracking-wide">Table Bills</p>
                                            <p data-table-bill-helper class="text-xs text-gray-500">Visible when Table Management is enabled</p>
                                            <div class="flex items-center gap-2 mt-2">
                                                <span class="text-sm">Copies per bill</span>
                                            ...
                                            <label class="inline-flex items-center gap-2 text-sm mt-2">
                                                ...
                                                <span>Cut after table bills</span>
                                            </label>
                                        </div>
                                    </div>
                                </div>
